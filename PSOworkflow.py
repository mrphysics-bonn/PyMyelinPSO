...
###############################################################################
    ...
    def write_json(self, path: str):
        ...
        save_path    = f'{path}parameters.json'
        os.makedirs(os.path.dirname(save_path), exist_ok=True)

        norm_obs      = self.config.source.data.norm_max
        gaus_filt_obs = self.config.source.data.gauss_filt
        ...
        if self.inv_SI==True:
            ...
            json_data    = {"data source":{
                                ...
                                "_noise added": False,
                                "_norm decay":  norm_obs,
                                "_gauss filt":  gaus_filt_obs[0],
                                "_SNR":         np.nan,
                                "_n echos":     dat_space},
...
###############################################################################
    ...
    def result2array(self, results: dict, result_map: np.array, 
